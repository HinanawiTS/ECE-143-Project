...
mo_shots = mo_salah[["Header","Distance", "Angle","Counter Attack","strong foot", "First Half","Goal","X","Y"]]
...
pitch_mo = Pitch(pitch_color ='black', line_color = 'white', stripe=False,pitch_type='wyscout')
...
sc1 = pitch_mo.scatter(mo_goal_x, mo_goal_y,
                    # size varies between 100 and 1900 (points squared)
                    s=(mo_probs_goals * 1500 + 50 ) ,
                     # give the markers a charcoal border
                    c='cyan',  # no facecolor for the marker
                    # for other markers types see: https://matplotlib.org/api/markers_api.html
                    marker='o',
                    ax=ax)
...
rich_shots = richarlison[["Header","Distance", "Angle","Counter Attack","strong foot", "First Half","Goal","X","Y"]]
